...
Exposes Eason's personal knowledge base (2422+ Readwise articles + Obsidian Wiki) as MCP tools, compatible with Raycast AI, Claude Code, Cursor, and any MCP-capable AI client.
...
| `ask_knowledge_base` | Full RAG answer using both Readwise + Wiki context |
...
```bash
cd /Users/admin/Documents/ClaudeCode/llm-wipa/mcp
npm install
```
...
```json
{
  "llm-kb": {
    "command": "node",
    "args": ["/Users/admin/Documents/ClaudeCode/llm-wipa/mcp/index.js"],
    "env": {
